...
double ternary_search_minimum_doubles(double b, double c,double l, double r)
{
    for (int i = 0; i < 100; i++)
    {
        double m1 = l + (r - l) / 3.0;
...
int32_t main()
{
    ...
    for (int cs = 1; cs <= t; cs++)
    {
        ...
        double min_x=ternary_search_minimum_doubles(b,c,0,M_PI/2);
        double ans=f(b,c,min_x);
